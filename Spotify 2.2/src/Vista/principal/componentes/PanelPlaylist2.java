...
public abstract class PanelPlaylist2 extends JPanel {
    ImageIcon iPlay2, iFondoUp, iFondoDown;

    public PanelPlaylist2() {
        cargarPropiedades();
        cargarRecursos();
        cargarCanciones();
        cargarTextos();
    ...
    private void cargarRecursos() {
        ...
        iPlay2 = new ImageIcon("img/130playlist2.jpeg");
        iFondoUp = new ImageIcon("img/bgarribaplay2.png");
        iFondoDown = new ImageIcon("img/bgabajoplay2.png");
    ...
    private void cargarTextos() {
        JLabel txtPlay1 = crearObjetos.crearTexto("Playlist #2", 180, 100, 500, 90, Color.white, recursos.fuente3);
        add(txtPlay1);
        
        JLabel txtCanciones = crearObjetos.crearTexto("15 Canciones", 180, 
